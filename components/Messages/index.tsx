...
export const withdrawMessage = (tx: any) => {
    message.success(
        <>
            Withdrawal successful, your transaction can be verified{' '}
            <a href={`https://polygonscan.com/tx/${tx.transactionHash}`} target="_blank" rel="noopener noreferrer">
                here
            </a>
        </>,
        5
...
export const depositMessage = (tx: any) => {
    message.success(
        <>
...
export const approveMessage = (tx: any) => {
    message.success(
        <>
